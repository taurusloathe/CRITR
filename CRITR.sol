...
contract CRITR is ERC20, ReentrancyGuard, Ownable {
    ...
    uint256 private price; // Price variable for Price Oracle
    ...
    // Constructor
    constructor(address _uniswapRouterAddress, address initialOwner) ERC20("CRITR", "CRITR") Ownable(initialOwner) {
    ...
    function exponentialCurve(uint256 tokensSold) internal view returns (uint256) {
        ...
        return INITIAL_PRICE * (2 ** (tokensSold / 500)); // Adjust the curve parameters as needed
    }
