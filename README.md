...
The app deploys a factory smart contract that deploys a token contract and a price oracle contract. Before deployment, the app user will be able to customize the name of their savings token in the user interface.
# Updates:
# Cross-Chain Bridge
